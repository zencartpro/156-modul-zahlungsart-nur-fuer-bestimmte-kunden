 ...
 * @version $Id: customers.php for Zahlungsart nur fuer bestimmte Kunden anbieten 2020-08-25 14:50:51Z webchills $
 */
  ...
  switch ($action) {
    ...
    case 'update':
       // bof Zahlungsart nur fuer bestimmte Kunden anbieten 
        if (isset($_POST['optional_payment_1']) && 
                 zen_not_null($_POST['optional_payment_1'])) {
           $optional_payment_1 = 1; 
        } else { 
           $optional_payment_1 = 0; 
        }
    ...
    case 'deleteconfirm':
      ...
      break;
    default:
      $customers = $db->Execute("SELECT c.customers_id, c.customers_gender, c.customers_firstname, c.optional_payment_1,
    ...
    <div class="container-fluid">
      ...
      if ($action == 'edit' || $action == 'update') {
        ...
        <div class="formArea">
          ...
          <!-- bof Zahlungsart nur fuer bestimmte Kunden anbieten  --> 
          <div class="form-group"> 	
  	      <?php echo zen_draw_label(TEXT_OPTIONAL_PAYMENT, 'optional_payment_1', 'class="col-sm-3 control-label"'); ?>
  	      <div class="col-sm-9 col-md-6">
          <?php echo zen_draw_checkbox_field('optional_payment_1', $cInfo->optional_payment_1, ($cInfo->optional_payment_1 == 1  ? true : false) ); ?>
          </div>
          </div>  
         <!-- eof Zahlungsart nur fuer bestimmte Kunden anbieten  --> 
